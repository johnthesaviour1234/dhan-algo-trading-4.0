/**
 * Multi-TF Breakout WDH ADX 1H 0.5 Strategy - Types
 * 
 ...
 * Exit: Stop Loss OR Target Profit (1:0.5 R:R) OR Market Close
 * 
 * Conservative 0.5x target profit variant.
 */
...
/**
 * Multi-TF Breakout WDH ADX 1H 0.5 Configuration
 */
export interface MultiTFBreakoutWDHADX1H05Config extends BaseStrategyConfig {
...
/**
 * Analytics specific to WDH ADX 1H 0.5 strategy
 */
export interface MultiTFBreakoutWDHADX1H05Analytics {
    totalTrades: number;
...
/**
 * Export format for WDH ADX 1H 0.5 strategy
 */
export interface MultiTFBreakoutWDHADX1H05Export {
    exportDate: string;
    backtestPeriod: {
        start: string;
        end: string;
...
/**
 * Default configuration - 1:0.5 R:R (no Monthly condition)
 */
export const DEFAULT_CONFIG: MultiTFBreakoutWDHADX1H05Config = {
    name: 'Multi-TF Breakout WDH ADX 1H 0.5',
    version: '1.0.0',
    direction: 'long',
    params: {
        ...
        // 1:0.5 Risk:Reward - Conservative target
        riskRewardRatio: 0.5,
