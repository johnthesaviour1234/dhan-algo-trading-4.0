/**
 * Multi-TF Breakout WDH ADX 1H 0.5 Strategy - Main Implementation
 * 
 ...
 * 
 * Conservative 0.5x target variant for more frequent wins.
 */

import { CandlestickData } from 'lightweight-charts';
import { BaseStrategy, Signal, BaseTrade, BasicMetrics } from '../BaseStrategy';
import { MultiTFBreakoutWDHADX1H05Config, MultiTFBreakoutWDHADX1H05Analytics, MultiTFBreakoutWDHADX1H05Export, HTFLevels, DEFAULT_CONFIG } from './types';
...
export class MultiTFBreakoutWDHADX1H05Strategy implements BaseStrategy<MultiTFBreakoutWDHADX1H05Config, MultiTFBreakoutWDHADX1H05Analytics, MultiTFBreakoutWDHADX1H05Export> {
    readonly name = 'Multi-TF Breakout WDH ADX 1H 0.5';
    readonly version = '1.0.0';
    readonly description = 'Breakout W/D/H (no Monthly) + Hourly ADX > 25 with 1:0.5 R:R';
     ...
     */
    private isWithinTradingWindow(date: Date, config: MultiTFBreakoutWDHADX1H05Config): boolean {
     ...
     */
    generateSignals(ohlcData: CandlestickData[], config: MultiTFBreakoutWDHADX1H05Config = DEFAULT_CONFIG): Signal[] {
    ...
    generateSignalsWithCalculations(
        ...
        config: MultiTFBreakoutWDHADX1H05Config = DEFAULT_CONFIG
    ): {
        signals: Signal[];
    ...
    ): MultiTFBreakoutWDHADX1H05Analytics {
    ...
    formatExport(
        ...
        analytics: MultiTFBreakoutWDHADX1H05Analytics,
        dateRange: { start: string; end: string }
    ): MultiTFBreakoutWDHADX1H05Export {
        return {
...
// Singleton instance
export const multiTFBreakoutWDHADX1H05Strategy = new MultiTFBreakoutWDHADX1H05Strategy();
