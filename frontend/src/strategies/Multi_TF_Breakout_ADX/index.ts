/**
 * Multi-TF Breakout ADX Strategy - Main Implementation
 * 
 ...
 * 
 * Critical: ADX is calculated using completed daily candles to prevent look-ahead bias.
 */

import { CandlestickData } from 'lightweight-charts';
import { BaseStrategy, Signal, BaseTrade, BasicMetrics } from '../BaseStrategy';
import { MultiTFBreakoutADXConfig, MultiTFBreakoutADXAnalytics, MultiTFBreakoutADXExport, HTFLevels, DEFAULT_CONFIG } from './types';
...
export class MultiTFBreakoutADXStrategy implements BaseStrategy<MultiTFBreakoutADXConfig, MultiTFBreakoutADXAnalytics, MultiTFBreakoutADXExport> {
    readonly name = 'Multi-TF Breakout ADX';
    readonly version = '1.0.0';
    readonly description = 'Breakout when price exceeds all HTF levels (1H/D/W/M) + Daily ADX > 25';
     ...
     */
    private isWithinTradingWindow(date: Date, config: MultiTFBreakoutADXConfig): boolean {
     ...
     */
    generateSignals(ohlcData: CandlestickData[], config: MultiTFBreakoutADXConfig = DEFAULT_CONFIG): Signal[] {
    ...
    generateSignalsWithCalculations(
        ...
        config: MultiTFBreakoutADXConfig = DEFAULT_CONFIG
    ): {
        signals: Signal[];
...
// Singleton instance
export const multiTFBreakoutADXStrategy = new MultiTFBreakoutADXStrategy();
