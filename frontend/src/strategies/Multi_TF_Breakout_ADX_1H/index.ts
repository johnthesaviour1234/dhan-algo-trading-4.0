/**
 * Multi-TF Breakout ADX 1H Strategy - Main Implementation
 * 
 ...
 * 
 * Critical: ADX is calculated using completed hourly candles to prevent look-ahead bias.
 */

import { CandlestickData } from 'lightweight-charts';
import { BaseStrategy, Signal, BaseTrade, BasicMetrics } from '../BaseStrategy';
import { MultiTFBreakoutADX1HConfig, MultiTFBreakoutADX1HAnalytics, MultiTFBreakoutADX1HExport, HTFLevels, DEFAULT_CONFIG } from './types';
...
export class MultiTFBreakoutADX1HStrategy implements BaseStrategy<MultiTFBreakoutADX1HConfig, MultiTFBreakoutADX1HAnalytics, MultiTFBreakoutADX1HExport> {
    readonly name = 'Multi-TF Breakout ADX 1H';
    readonly version = '1.0.0';
    readonly description = 'Breakout when price exceeds all HTF levels (1H/D/W/M) + Hourly ADX > 25';
     ...
     */
    private isWithinTradingWindow(date: Date, config: MultiTFBreakoutADX1HConfig): boolean {
     ...
     */
    generateSignals(ohlcData: CandlestickData[], config: MultiTFBreakoutADX1HConfig = DEFAULT_CONFIG): Signal[] {
    ...
    generateSignalsWithCalculations(
        ...
        config: MultiTFBreakoutADX1HConfig = DEFAULT_CONFIG
    ): {
        signals: Signal[];
...
// Singleton instance
export const multiTFBreakoutADX1HStrategy = new MultiTFBreakoutADX1HStrategy();
